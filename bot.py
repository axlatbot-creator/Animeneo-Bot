...
#                        KONFIGURATSIYA
# ============================================================
BOT_TOKEN = "8934406318:AAESw6z24t7Ot3LtU872WR7GNvKRhJtEKi4"
...
def check_subscription(user_id):
    """Barcha majburiy kanallarga obunani tekshiradi.
    MUHIM: API xatosi yoki noaniq holatda foydalanuvchi HECH QACHON avtomatik
    'obuna bo'lgan' deb hisoblanmaydi — xato logga yoziladi va False qaytariladi."""
